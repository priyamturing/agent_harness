...
class ClaudeAgent(Agent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            model (str): Exact model name as supported by Anthropic API 
                (e.g., "claude-sonnet-4-5"). Defaults to "claude-sonnet-4-5".
    ...
    def _build_llm(self) -> Union[BaseChatModel, Runnable]:
        ...
        Returns:
            Union[BaseChatModel, Runnable]: Configured ChatAnthropic instance, 
                optionally with tools bound. Automatically handles thinking mode 
                setup and token budget adjustments.
        """
        config: dict[str, Any] = {
            "model": self.model,
