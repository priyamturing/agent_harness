...
class GeminiAgent(Agent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            model (str): Exact model name as supported by Google API 
                (e.g., "gemini-2.5-pro", "gemini-2.0-flash"). Defaults to "gemini-2.5-pro".
            ...
            **kwargs: Additional keyword arguments passed directly to 
                ChatGoogleGenerativeAI constructor (e.g., api_key, etc.).
