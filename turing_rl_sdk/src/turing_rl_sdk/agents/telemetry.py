...
def configure_langsmith(
    ...
    Args:
        project_name (Optional[str]): LangSmith project name shown in UI. 
            Defaults to "TURING_RL" if not set.
    ...
    Example:
        ...
        >>> os.environ["LANGCHAIN_PROJECT"] = "turing-rl"
    ...
    if enabled:
        ...
        if project_name:
            ...
            env_vars["LANGCHAIN_PROJECT"] = "TURING_RL"
    else:
...
def print_trace_summary(project_name: Optional[str] = None, limit: int = 10) -> None:
    ...
    Example:
        >>> print_trace_summary("turing-rl", limit=5)
        Recent Traces (turing-rl):
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
