...
class GPTAgent(Agent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            model (str): Model name identifier. Accepts "gpt-5-high", "gpt-5", 
                "gpt-4o", "o4-mini", etc. Defaults to "gpt-5-high". Reasoning 
                models (GPT-5, o-series) get special encrypted reasoning support.
            ...
            reasoning_effort (str): Reasoning effort level for reasoning-capable 
                ...
                to GPT-5 and similar reasoning models.
    ...
    def _build_llm(self) -> Union[BaseChatModel, Runnable]:
        ...
        Returns:
            Union[BaseChatModel, Runnable]: Configured ChatOpenAI instance, 
                ...
                - Model name normalization (e.g., gpt-5-high → gpt-5)
